            ...
            if (state.hasAvailableDoctorData) {
              if (state.availableDoctors!.availableDoctors!.isEmpty) {
                ...
                return Expanded(
                  ...
                  itemCount: state.availableDoctors!.availableDoctors!.length,
                  itemBuilder: (context, i) => InkWell(
                    onTap: () => Navigator.of(context).pushNamed(
                        BookNewAppointmentScreen.routeName,
                        arguments: state.availableDoctors!.availableDoctors ![i]),
                    child: AvailableDoctorCard(
                      data: state.availableDoctors!.availableDoctors![i],
                    ),
                  ),
                ));
              }
