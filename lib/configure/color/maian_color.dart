...
class MainConfigColorsLightTheme {
  MainConfigColorsLightTheme._();

  static const Color primary = Color(0xFFA76FEC);
  static const Color secondary = Color(0xFFE9DBFA);
  ...
  static const Color inputFiled = Color(0xFFEEEEEE);
...
class MainConfigColorsDarkTheme {
  MainConfigColorsDarkTheme._();

  static const Color primary = Color(0xFFA76FEC);
  static const Color secondary = Color(0xFF6F57ED);
